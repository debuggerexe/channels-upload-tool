...
PLATFORMS = {
    ...
    'bilibili': {
        'name': 'B站创作中心',
        'cookie_file': 'cookies/bilibili/account.json',
        'cookie_example': 'examples/get_bilibili_cookie.py',
...
async def open_browser(platform: str):
    ...
    async with async_playwright() as playwright:
        ...
        await page.goto(config['url'], timeout=60000, wait_until='domcontentloaded')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--bilibili', action='store_true', help='打开B站创作中心')
